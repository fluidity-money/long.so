...
export type SeawaterLiquidity = {
  ...
  /** USD value of the liquidity in this range. */
...
export type ManagePoolFragmentFragment = { __typename?: 'SeawaterPool', address: string, id: string, earnedFeesAPRFUSDC: Array<string>, token: { __typename?: 'Token', symbol: string, name: string, decimals: number }, liquidityIncentives: { __typename?: 'Amount', valueScaled: string }, superIncentives: { __typename?: 'Amount', valueScaled: string }, utilityIncentives: Array<{ __typename?: 'UtilityIncentive', amountGivenOut: string, maximumAmount: string }>, positions: Array<{ __typename?: 'SeawaterPosition', positionId: string, lower: number, upper: number }> } & { ' $fragmentName'?: 'ManagePoolFragmentFragment' };
