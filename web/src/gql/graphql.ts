...
export type ForUserQuery = { __typename?: 'Query', getSwapsForUser: { __typename?: 'GetSwapsForUser', data: { __typename?: 'SeawaterSwaps', swaps: Array<(
  ...
  ) | null, getNotes: Array<{ __typename?: 'Note', content: string, placement: string }> };
