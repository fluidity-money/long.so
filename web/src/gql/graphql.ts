...
export type GetHoldersQuery = { __typename?: 'Query', token: { __typename: 'EnhancedToken', id: string, totalSupply?: string | null }, holders: { __typename: 'HoldersResponse', count: number, status: HoldersStatus, cursor?: string | null, items: Array<{ __typename: 'Balance', balance: string, shiftedBalance: number, tokenId: string, walletId: string }> } };
