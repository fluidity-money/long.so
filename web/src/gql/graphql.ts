...
export type WithdrawPositionsFragmentFragment = { __typename?: 'Wallet', positions: { __typename?: 'SeawaterPositionsUser', positions: Array<{ __typename?: 'SeawaterPosition', positionId: number, lower: number, upper: number, isVested: boolean, owner: { __typename?: 'Wallet', address: string }, liquidity: { __typename?: 'PairAmount', fusdc: { __typename?: 'Amount', valueUsd: string, valueScaled: string }, token1: { __typename?: 'Amount', valueUsd: string, valueScaled: string } } }> } } & { ' $fragmentName'?: 'WithdrawPositionsFragmentFragment' };
...
export type DepositPositionsFragmentFragment = { __typename?: 'Wallet', positions: { __typename?: 'SeawaterPositionsUser', positions: Array<{ __typename?: 'SeawaterPosition', positionId: number, lower: number, upper: number, isVested: boolean }> } } & { ' $fragmentName'?: 'DepositPositionsFragmentFragment' };
...
export type PositionsFragmentFragment = { __typename?: 'Wallet', id: string, positions: { __typename?: 'SeawaterPositionsUser', positions: Array<{ __typename?: 'SeawaterPosition', created: number, positionId: number, lower: number, upper: number, isVested: boolean, served: { __typename?: 'Served', timestamp: number }, pool: { __typename?: 'SeawaterPool', token: { __typename?: 'Token', name: string, address: string, symbol: string, decimals: number } }, liquidity: { __typename?: 'PairAmount', fusdc: { __typename?: 'Amount', valueUsd: string }, token1: { __typename?: 'Amount', valueUsd: string } } }> } } & { ' $fragmentName'?: 'PositionsFragmentFragment' };
