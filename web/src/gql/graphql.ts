...
export type StakeFormFragmentFragment = { __typename?: 'SeawaterPool', address: string, earnedFeesAPRFUSDC: Array<string>, config: { __typename?: 'SeawaterConfig', classification: SeawaterPoolClassification }, priceOverTime: { __typename?: 'PriceOverTime', daily: Array<string> } } & { ' $fragmentName'?: 'StakeFormFragmentFragment' };
