...
export type TokensFragmentFragment = { __typename?: 'SeawaterPool', token: { __typename?: 'Token', address: string, decimals: number, name: string, symbol: string } } & { ' $fragmentName'?: 'TokensFragmentFragment' };

export type FusdcFragmentFragment = { __typename?: 'Token', address: string, decimals: number, name: string, symbol: string } & { ' $fragmentName'?: 'FusdcFragmentFragment' };
