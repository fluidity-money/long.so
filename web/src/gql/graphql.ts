...
export type AllPoolsQuery = { __typename?: 'Query', pools: Array<{ __typename?: 'SeawaterPool', address: string, token: { __typename?: 'Token', name: string }, volumeOverTime: { __typename?: 'VolumeOverTime', daily: Array<{ __typename?: 'PairAmount', fusdc: { __typename?: 'Amount', valueScaled: string } }> }, tvlOverTime: { __typename?: 'TvlOverTime', daily: Array<string> }, liquidityIncentives: { __typename?: 'Amount', valueUnscaled: string }, superIncentives: { __typename?: 'Amount', valueUnscaled: string }, utilityIncentives: Array<{ __typename?: 'UtilityIncentive', maximumAmount: string, amountGivenOut: string }> }> };
