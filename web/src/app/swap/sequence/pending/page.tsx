...
export default function SequencePage() {
  return (
    <div className="flex flex-col items-center">
      <div className="absolute hidden h-[354px] w-[426px] bg-orange-300 mix-blend-darken blur-[163px] md:inline" />
      ...
      <div className="z-10 flex h-[248.914px] w-[266px] flex-col items-center rounded-lg bg-black p-2 text-white md:h-[328px] md:w-[393px]">
        ...
        <Image
          src={require("../../../../assets/gifs/pending.gif")}
          alt={"unlock"}
