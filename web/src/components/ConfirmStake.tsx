...
export const ConfirmStake = ({mode}: ConfirmStakeProps) => {
    ...
    const {writeContract: writeContractMint, data: mintData} =
        useWriteContract();
    const {
        ...
        <div className="z-10 flex flex-col items-center">
            ...
            >
              ...
              {" "}
                    ...
                    <div
                        className="mt-[19px] w-[212px] text-center text-3xs font-medium text-gray-2 md:mt-[17px] md:w-[250px] md:text-2xs">
