...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.requestTokens":
		if e.complexity.Mutation.RequestTokens == nil {
			break
		}

		args, err := ec.field_Mutation_requestTokens_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) field_Mutation_requestTokens_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Mutation_requestTokens_argsWallet(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["wallet"] = arg0
	arg1, err := ec.field_Mutation_requestTokens_argsTurnstileToken(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_requestTokens_argsWallet(
	ctx context.Context,
...
func (ec *executionContext) field_Mutation_requestTokens_argsTurnstileToken(
	ctx context.Context,
	rawArgs map[string]interface{},
) (string, error) {
	// We won't call the directive if the argument is null.
...
func (ec *executionContext) _Mutation_requestTokens(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_requestTokens(ctx, field)
	if err != nil {
		return graphql.Null
	}
...
func (ec *executionContext) fieldContext_Mutation_requestTokens(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_requestTokens_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "requestTokens":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_requestTokens(ctx, field)
			})
