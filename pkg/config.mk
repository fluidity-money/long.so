...
OUT_SEAWATER_SWAPS_A := seawater-swaps-a.wasm
OUT_SEAWATER_SWAP_PERMIT2_A := seawater-swap-permit2-a.wasm
OUT_SEAWATER_QUOTES_A := seawater-quotes-a.wasm
...
OUT_SEAWATER_SWAPS_B := seawater-swaps-b.wasm
OUT_SEAWATER_QUOTES_B := seawater-quotes-b.wasm
